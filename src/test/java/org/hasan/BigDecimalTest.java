...
public class BigDecimalTest {
    @Test
    public void testInaccurateCalculations() {
        double amount1 = 2.15;
        double amount2 = 1.10;
        assertThat(1.05 == (amount1 - amount2), is(false));

        // Although don't use the double constructor as that has the same problem as using doubles
    ...
    @Test
    public void testAccurateCalculations() {
